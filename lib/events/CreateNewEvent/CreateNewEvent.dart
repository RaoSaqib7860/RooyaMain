...
class _CreateNewEventState extends State<CreateNewEvent> {
  ...
  TextEditingController facilityCon = TextEditingController();
  TextEditingController fhoneCon = TextEditingController();
                        ...
                        : selectedValue == 2
                            ? Column(
                                ...
                                children: [
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        if (facilityCon.text
                                            .trim()
                                            .isNotEmpty) {
                                          listOfFacility.add(facilityCon.text);
                                          facilityCon.clear();
                                          setState(() {});
                                        }
                                      },
                                  ...
                                  Column(
                                    children: listOfFacility.map((e) {
                                      int index = listOfFacility.indexOf(e);
                                      return Padding(
  ...
  Future<void> createEvent(List files) async {
    ...
    print(jsonEncode({"files": files[0]}));
    final response = await http.post(Uri.parse('${baseUrl}postRooyaEvent$code'),
        headers: {"Content-Type": "application/json", "Authorization": token!},
        body: jsonEncode({
          "event_hashtag": hashTags,
          "event_tag_peoples": usersTags,
          "event_website": websiteCon.text,
          "event_facility": value,
          "event_contact": fhoneCon.text,
          "event_free_paid": isPublic ? "free" : 'paid',
          "event_pay_link": paymentCon.text,
          "event_privacy": isPublic ? "public" : 'private',
          "event_category": "1",
          "event_maker": userId,
          "event_title": eventTitleCon.text,
          "event_location": locationCon.text,
          "event_description": eventDisciptionCon.text,
          "event_start_date": startDateCon.text,
          "event_end_date": endDateCon.text,
          "event_cover": files[0],
          "files": files,
          "event_lat":"${mapresult!.geometry!.location.lat}",
          "event_long":"${mapresult!.geometry!.location.lng}",
        }));
