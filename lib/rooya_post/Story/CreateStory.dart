...
class CreatePostStrory extends StatefulWidget {
  final bool? fromHome;
  final String? eventID;

  const CreatePostStrory({Key? key, this.fromHome = true, this.eventID = '0'})
      : super(key: key);

  @override
  _CreatePostStroryState createState() => _CreatePostStroryState();
}

class _CreatePostStroryState extends State<CreatePostStrory> {
  ...
  var controller = Get.put(CreateStoryController());
