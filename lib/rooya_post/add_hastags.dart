...
class AddHashTags extends StatefulWidget {
  ...
  AddHashTags({Key? key,this.selectedHashTags,this.onAddHashTag}):super(key: key);
  @override
...
class _AddHashTagsState extends State<AddHashTags> {
  ...
  Future<void> getHashTags() async {
    ...
    final response = await http
        .get(Uri.parse('${baseUrl}getRooyaPostHashTag${code}'), headers: {
